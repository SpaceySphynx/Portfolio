    ...
    class Test
    {
        ...
        public static void Run(int labNumber)
        {
            ...
            for (int line = 0; line < inputs.GetLength(0); line++)
            {
                ...
                UI.DisplayHeader($"Test {line + 3}", ((line + 3) == 10));
                ...
                UI.DisplayPrograssBar(testScore, 10, Submission.GAME_MODE);

                Console.WriteLine($"{testScore} of 10 points");
            ...
            UI.DisplayPrograssBar(labScore, 80, 50, Submission.GAME_MODE);

            Console.WriteLine("Lab score: " + labScore + "\t" + fName +" of 80 (Lab 2 portion of assignment only)");
        }
    }
}
