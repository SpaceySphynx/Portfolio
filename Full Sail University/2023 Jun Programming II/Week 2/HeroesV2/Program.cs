            ...
            do
            {
                ...
                switch (selection)
                {
                    ...
                    case 2:
                        ...
                        // Get user's choice of attribute to sort by
                        Input.GetMenuChoice("Sort by? ", sortBy, out int sortBySelection);

                        // Convert user's choice to a SortBy varible sortByChoice
                        SortBy sortByChoice = (SortBy)sortBySelection;

                        // Call the SortByAttribute method to sort heroes by selected attribute
                    ...
                    case 3:
                        ...
                        // Initialize an empty string for variable heroName
                        string heroName = "";

                        // Get the hero name from the user
                        Input.GetString("Please enter the name of the hero to find: ", ref heroName);

                        // Call the FindHero method to find the hero
                        HeroesDB.FindHero(heroName);
                    ...
                    case 4:
                        ...
                        // Call the PrintGroupCounts method to print counts of heroes grouped by the first letter
                    ...
                    case 5:
                        ...
                        // Initialize an empty string for the heroLetter variable
                        string heroLetter = string.Empty;

                        // Get the first letter from the user
                        Input.GetString("Please enter the first letter of the hero to find: ", ref heroLetter);

                        // Call the FindHeroesByLetter method to find heroes by the first letter
                        HeroesDB.FindHeroesByLetter(heroLetter);
                    ...
                    case 6:
                        ...
                        // Initialize an empty string to hold the name of the hero to be removed
                        string heroToRemove = string.Empty;

                        // Get the name of the hero to be removed from the user
                        Input.GetString("Please enter the name of the hero to remove: ", ref heroToRemove);

                        // Call the RemoveHero method to remove the hero
                        HeroesDB.RemoveHero(heroToRemove);
