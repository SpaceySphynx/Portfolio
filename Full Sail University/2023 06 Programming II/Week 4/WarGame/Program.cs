...
using static WarGame.HighScore;
    ...
    */
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Set the output encoding for the Console to UTF8 because
            // the console was having issues displaying the card suit characters without this change.
            Console.OutputEncoding = System.Text.Encoding.UTF8;
            // Calls the LoadHighScores method from the HighScore class, passing in the highScoreFile string.
            ...
            List<string> cards = CardWars.LoadCards(cardsFile);
            ...
            do
            {
                ...
                switch (selection)
                {
                    case 1:
                        ...
                        // Pretty much as the comment aboves says.
                    ...
                    case 2:
                        ...
                        // use a foreach loop to loop through the card in cards and write to the console.
                    ...
                    case 3:
                        ...
                        // Call the PlayGame method passing cards, highScores and highScorefile to begin game of War.
                        CardWars.PlayGame(cards, highScores, highScoreFile);
                        break;
                    case 4:
                        LabTests.RunTests();
                        break;
