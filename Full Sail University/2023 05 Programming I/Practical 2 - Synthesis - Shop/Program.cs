...
//       When all work is done in Item.cs and Inventory.cs uncomment the following line.
#define INVENTORY
...
namespace Shop
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //       Define an Inventory object for the player,
            ...
            Console.WriteLine("Please enter yoru character's name: ");
            ...
            {
                name = "Jordan";
                Console.WriteLine($"No name was entered so your name has been set to Jordan.");
            }
            ...
            //       Use the Gold property to give the player inventory 200 Gold.
            ...
            foreach (Item item in PlayerStartingItems)
            {
                // Add each item to the player's inventory
                playerInventory.AddItem(item);
            }

            //       Use the Gold property to give the store inventory 350 Gold.

            storeInventory.Gold = 350;

            //       Use the AddItem method to add each item in the
            //		 StoreStartingItems array to the store's inventory.
            
            foreach (Item item in StoreStartingItems)
            {
                // Add each item to the player's inventory
            ...
            while (true)
            {
                ...
                do
                {
                    ...
                    //       Call the ShowInventories method and pass in the player's name,
                    //		 the player's inventory and the store's inventory.
                    ShowInventories(name, playerInventory, storeInventory);
                ...
                //       Call the DoTransaction method and send it the player's name,
                //		 the player's inventory, the store's inventory and the doBuy variable.
                DoTransaction(name, playerInventory, storeInventory, doBuy);
            }
